DROP DATABASE IF EXISTS college_filtering_db;
CREATE DATABASE college_filtering_db;
USE college_filtering_db;
...
-- Q2
SELECT * FROM Student WHERE Name LIKE '%i' AND CHAR_LENGTH(Name) >= 6;
-- Q3
SELECT * FROM Student WHERE CGPA BETWEEN 7.50 AND 9.00;
-- Q4
