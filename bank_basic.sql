DROP DATABASE IF EXISTS bank_basic_db;
CREATE DATABASE bank_basic_db;
USE bank_basic_db;
...
-- Q1
SELECT Account_no, Customer_name, Balance FROM Account;
-- Q2
SELECT * FROM Branch WHERE City = 'Mumbai';
-- Q3
SELECT COUNT(*) AS total_accounts FROM Account;
-- Q4
RENAME TABLE Branch TO Branch_Details;
