DROP DATABASE IF EXISTS hospital_basic_db;
CREATE DATABASE hospital_basic_db;
USE hospital_basic_db;
...
-- Q1
SELECT Name, Age, Blood_group FROM Patient;
-- Q2
SELECT * FROM Doctor WHERE Specialization = 'Cardiology';
-- Q3
SELECT COUNT(*) AS total_patients FROM Patient;
-- Q4
RENAME TABLE Doctor TO Doctor_Info;
